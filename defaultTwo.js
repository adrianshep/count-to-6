...
In JavaScript, unlike some other languages, default arguments can be
expressions:
...
function that will make a string really important. It should do this by adding a
bunch of exclamation marks after it. The exact number of exclamation marks
