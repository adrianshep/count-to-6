...
ES6 template strings are a new string syntax, which use backticks ( `` ) instead
of quotation marks ( '' or "" ). Template strings give you more powerful
abilities for constructing strings. They allow string interpolation, with syntax
like:
...
solution should use a single ES6 template string, and not use the + operator.
