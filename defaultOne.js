...
default export is a function. This time it will take two arguments: a lower
bound and an upper bound. Your function should return the midpoint between those
two bounds.
...
As before, you don't need to print anything to the console. Your solution should
look something like:
...
sometimes none, sometimes one, sometimes two. Sometimes we'll pass in an
explicit undefined, and you should be sure to treat that as the default.
